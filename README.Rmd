...
- for extended import and export (export to Witec ASCII graph format with `write.txt.Witec.Graph()` or to JCAMP-DX with `write_jdx()`, import of OPUS binary files with `read_opus()`)
