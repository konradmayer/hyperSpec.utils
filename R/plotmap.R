...
#' @return
#' @export
plotmap_viridis <- function(object, model = spc ~ x * y, func = mean, func.args = list(), ...) {
  hyperSpec::plotmap(object, model = model, func = func, func.args = func.args, par.settings = rasterVis::viridisTheme(), ...)
}
